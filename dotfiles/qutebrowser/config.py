...
config.bind(',ww', 'spawn --userscript qute_pass')
config.bind(',rr', 'spawn --userscript readability')
config.bind(',t', 'spawn --userscript translate')
config.bind('gc', 'spawn --userscript gitclone')
# config.bind(',b', 'spawn --userscript qb_wallabag')
...
config.bind(',sh', 'session-load -c home')
config.bind(',sr', 'session-load -c srht')
config.bind(',sk', 'session-load -c kube')


# config.bind(',hh', 'session-load -c homelab')
# config.bind(',ff', 'session-load -c forum')

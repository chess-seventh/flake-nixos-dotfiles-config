...

{
  programs.git = {
    ...
    includes = [
      {
        condition = "gitdir:~/src/work/signicat/**";
        contents = {
          credential = { 
            url = "gitlab.com";
            username = "frapiv@signicat.com";
            helper = "!f() { test \"$1\" = get && echo \"password=$(pass work/signicat/gitlab.com/frapiv@signicat.com)\"; }; f";
          };
          user = {
            name = "Francesco Piva";
            email = "frapiv@signicat.com";
            signingkey = "24A36F7AE90207E892122C6A196DE4B1C466C207";
          };
          commit = {
            gpgSign = true;
          };
    ...
    extraConfig = {
      ...
      user = {
        ...
        personal = {
          ...
          signingkey = "DBC4A6C7DF1A29A18558D2B3A7D05D40C1C0C0F4";
        };
      };
